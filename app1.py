...
#1 Pairplot to visualize relationships between multiple numeric variables
...
print("Predicted grades:", [int(x) for x in list(random_forest_model.predict(test_X.tail()))], sep="\n")
